      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-soft">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center h-20 lg:h-24">
            <Link
              to="/"
              className="flex items-center gap-2 font-sans-elegant text-xs tracking-[0.2em] uppercase text-nude-700 hover:text-rose-gold-500 transition-colors duration-300"
            >
                ...
                <div className="relative aspect-[4/5] bg-gradient-to-br from-baby-rose-100 to-cream-100 mb-6 overflow-hidden">
                  {imagem ? (
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center px-4">
                      <Icon className="w-8 h-8 text-rose-gold-300 mx-auto mb-3" style={{ strokeWidth: 1 }} />
